  ...
  $(function() {
   ...
   var arrLang = {
     ar : {
       ...
       titre4:"واجبات تنفيدية",
       obl_1:" وهي واجبات تبعث في قلبك إذا تأملتها أن هذه الرحلة هي آخر رحلات حياتك، وأنك لن ترجع بعدها إلى دارك بل إلى قبر،
          وأنك تستعد لحلول أجلك مع آخر خطوة تخطوها من طواف الوداع، فيدفعك قصر الأمل وقطع تعلق القلب بالعودة إلى أن تجدفي
           السير وتتقن الحج.
           قال ابن عقيل رحمه الله :'
           ما تصفو الأعمال والأحوال إلا بتقصير الآمال، فإن كل من عد ساعته التي هو فيها كساعته عند مرض الموت حسنت
           أعماله،
           فصار
           عمره كله صافيا '.   فأد حجتك دون أن تخلف أي تبعة وراء ظهرك، وذلك بأن تحرص على ما يلي :",
       obl_2:"",
       obl_3:"",
       obl_4:"",
       obl_5:"",
