...
// var lan = {
//   ar : {
//     wel:".وهو أن ينوي المسلم عند إحرامه أداء مناسك الحج فقط، ويقول: 'لبيك بحج'، ثمَّ يصل إلى مكة ويؤدي  مناسك الحج ثمَّ يحرم بنية العمرة ويؤدي مناسكها، وهو الحج الأفضل عند الشافعية والمالكية، وفيما يأتي من فقرات هذا المقال  سيتم الحيث عن الحج المفرد وشروطه بالتفصيل"
//   },
//   fr : {
//     welecome :"C’est le meilleur Hajj pour Shafi’i et Maliki, c’est le fait de formuler, au moment de sacralisation pour le Hajj au cours des mois du pèlerinage à partir du Mîqât, l’intention d’accomplir uniquement le Hajj, en disant : « labbayka bi hajj »,Le pèlerin donc  accomplit le tawaf e d’arrivée (al-qoudoum) et demeure en ihram jusqu’au moment du Hajj ; pour accomplir les rites du Hajj. Lorsqu’il termine les rites de Hajj , il ressort de la Mecque et se remet en état de l’Ihram avec l’intention de faire la Omra ."
//   }
// };
// myEmitter.once('refresh', function(){
//     location.reload(true);
// })

/*
ele_ar.onclick=function(){
  ifrad.textContent = lan.ar.wel
  location.reload(true)
}
ele_fr.onclick=function(){
  ifrad.textContent = lan.fr.welecome
  location.reload(true)
}
$("#fr").click(function(){
   location.reload(true);
